# Проект по автоматизации тестирования сайта Axeta
...
>- [x] *Проверка баннера главной страницы*
>- [x] *Вызов формы обратной связи, валидация контактов*
>- [x] *Отправка формы обратной связи со страницы /contacts*
>- [x] *Проверяем H1 на странице проекта*
...
## <img width="4%" title="Allure Report" src="images/logo/Allure.svg"> Отчет о результатах тестирования в [Allure Report](https://jenkins.autotests.cloud/job/15-onemanpara-hw15-axetademo/allure/)
